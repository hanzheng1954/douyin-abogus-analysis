...
(async () => {
  ...
  fs.writeFileSync('/home/exedev/gan/douyin-re/mitm3_log.txt', logs.join('\n'));
  fs.writeFileSync('/home/exedev/gan/douyin-re/mitm3_appends.json', JSON.stringify(appends, null, 2));
