...
| 11 | Python 移植 | `python3 abogus_py.py`（忠实路线）/ `abogus_full.py`（旧路线） | ⏳ 长度 168 两侧一致；5 次 SM3 输入、37 次熵抽取、程序 280 入参均已逐一对齐，**仅剩 9 个字符差异**（解码字节 11/125 位，见 §五 与 [PY_PORT_REPORT.md](PY_PORT_REPORT.md)） |
